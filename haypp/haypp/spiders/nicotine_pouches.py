...
class NicotinePouchesSpider(Spider):
    ...
    def parse(self, response):
        ...
        item.add_xpath("flavour_facts", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Flavour']/td[2]/a/text()")
        item.add_xpath("nicotine_strength_mg_pouch", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Nicotine strength (mg/pouch)']/td[2]/text()")
        item.add_xpath("nicotine_strength_mg_g", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Nicotine strength (mg/g)']/td[2]/text()")
        item.add_xpath("pouches_per_can", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Pouches per can']/td[2]/text()")
        item.add_xpath("weight_per_pouch_gram", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Weight per pouch (gram)']/td[2]/text()")
        item.add_xpath("content_per_can_gram", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Content per can (gram)']/td[2]/text()")
        item.add_xpath("producer", "//div[contains(@class, 'p-info-section')]/div[contains(text(), 'Facts')]/following-sibling::div//tr[td='Producer']/td[2]/text()")
